...
public class DigitalRoot {
  ...
  /**
   * Part A: Recursive function to find sum of digits Time Complexity: O(n) where n is length of the
   * string Space Complexity: O(n) due to recursion stack
   */
  ...
  /**
   * Part B: Find digital root using iteration Time Complexity: O(log(n)) in most cases Space
   * Complexity: O(1)
   */
  ...
  /**
   * Alternative iterative implementation for digital root Using mathematical property: digital root
   * = 1 + (num - 1) % 9 More efficient for very large numbers
   */
